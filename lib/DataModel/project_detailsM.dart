...
class ProjectDetailsM {
  ...
  factory ProjectDetailsM.fromJson(String str) =>
      ProjectDetailsM.fromMap(json.decode(str));
...
class Result {
  ...
  factory Result.fromMap(Map<String, dynamic> json) => Result(
        allSlider: List<AllSlider>.from(
            json["all_slider"].map((x) => AllSlider.fromMap(x))),
...
class ProjectDetails {
  ...
  factory ProjectDetails.fromJson(String str) =>
