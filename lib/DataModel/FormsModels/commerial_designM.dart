...
//
//     final commercialDesignM = commercialDesignMFromMap(jsonString);

import 'dart:convert';

class CommercialDesignM {
  CommercialDesignM({
    this.message,
    this.codenum,
    this.status,
  ...
  factory CommercialDesignM.fromJson(String str) => CommercialDesignM.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CommercialDesignM.fromMap(Map<String, dynamic> json) => CommercialDesignM(
