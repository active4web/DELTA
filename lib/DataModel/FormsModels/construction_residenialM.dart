...
//
//     final constResidentialM = constResidentialMFromMap(jsonString);

import 'dart:convert';

class ConstResidentialM {
  ConstResidentialM({
    this.message,
    this.codenum,
    this.status,
  ...
  factory ConstResidentialM.fromMap(Map<String, dynamic> json) => ConstResidentialM(
