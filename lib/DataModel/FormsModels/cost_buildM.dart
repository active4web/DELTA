...
//
//     final buildCostM = buildCostMFromMap(jsonString);
...
class BuildCostM {
  ...
  factory BuildCostM.fromJson(String str) => BuildCostM.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory BuildCostM.fromMap(Map<String, dynamic> json) => BuildCostM(
