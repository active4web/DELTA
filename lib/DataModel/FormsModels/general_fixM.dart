...
//
//     final generalFixM = generalFixMFromMap(jsonString);
...
class GeneralFixM {
  ...
  factory GeneralFixM.fromJson(String str) => GeneralFixM.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GeneralFixM.fromMap(Map<String, dynamic> json) => GeneralFixM(
