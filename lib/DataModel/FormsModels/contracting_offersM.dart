...
//
//     final contractingOffersM = contractingOffersMFromMap(jsonString);

import 'dart:convert';

class ContractingOffersM {
  ContractingOffersM({
    this.message,
    this.codenum,
    this.status,
  ...
  factory ContractingOffersM.fromJson(String str) => ContractingOffersM.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ContractingOffersM.fromMap(Map<String, dynamic> json) => ContractingOffersM(
