...
//
//     final realStateM = realStateMFromMap(jsonString);
...
class RealStateM {
  ...
  factory RealStateM.fromJson(String str) => RealStateM.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory RealStateM.fromMap(Map<String, dynamic> json) => RealStateM(
