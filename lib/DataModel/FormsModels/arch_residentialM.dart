...
//
//     final archResidentialM = archResidentialMFromMap(jsonString);

import 'dart:convert';

class ArchResidentialM {
  ArchResidentialM({
    this.message,
    this.codenum,
    this.status,
  ...
  factory ArchResidentialM.fromJson(String str) => ArchResidentialM.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ArchResidentialM.fromMap(Map<String, dynamic> json) => ArchResidentialM(
