            ...
            builder: (context, snapshot) {
              if (snapshot.data != null) {
                return CustomTabView(
                    ...
                    itemCount:
                        snapshot.data?.result?.allCategories?.length ?? 0,
                    tabBuilder: (context, index) => Tab(
                        text:
                            "${snapshot.data?.result?.allCategories?[index].categoryName}"),
                    pageBuilder: (
                      context,
                      index,
                    ) =>
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                    ...
                                                    child: Text(
                                                      "${snapshot.data?.result?.allCategories?[index].allArticles?[index2].productName}",
                                                      textDirection:
                                                          TextDirection.rtl,
                                                      style: TextStyle(
                                                          color:
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                    ...
                                                    child: Text(
                                                      "${snapshot.data?.result?.allCategories?[index].allArticles?[index2].smallDescription}",
                                                      textDirection:
                                                          TextDirection.rtl,
                                                      style: TextStyle(
                                                          color:
