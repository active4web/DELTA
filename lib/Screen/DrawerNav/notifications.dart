            ...
            if (snapshot.data != null) {
              if (snapshot.data?.result?.allNotifications != []) {
                return ListView.builder(
                  ...
                  itemCount:
                      snapshot.data?.result?.allNotifications?.length ?? 0,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (_) => NotifyDetails(
                                        notifyId: snapshot.data?.result
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            ...
                                            image: snapshot.data?.result?.allNotifications?[index].img == ""
                                                ? AssetImage('assets/images/Icon-check.png') as ImageProvider
                                                : NetworkImage(snapshot.data?.result?.allNotifications?[index].img??"",),
                                        ),
                                      ),
                                      width: size.width * .2,
                                      height: size.width * .2,
